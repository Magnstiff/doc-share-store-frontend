...
<template>
  ...
  <div class="viewer">
    ...
    <TxtViewer
      v-else-if="fileType === 'txt' || fileType === 'java' || fileType === 'vue' || fileType === 'js' || fileType === 'c' || fileType === 'cpp' || fileType === 'html' || fileType === 'css'"
      :url="url" />
    <MusicViewer
      v-else-if="fileType === 'mp3' || fileType === 'wma' || fileType === 'wav' || fileType === 'ape' || fileType === 'flac' || fileType === 'ogg' || fileType === 'acc'"
      :url="url" />
    <PictureViewer
      v-else-if="fileType === 'bmp' || fileType === 'jpeg' || fileType === 'png' || fileType === 'svg' || fileType === 'psd' || fileType === 'jpg' || fileType === 'gif'"
      :url="url" />
    <VideoViewer
      v-else-if="fileType === 'mp4' || fileType === 'avi' || fileType === 'dat' || fileType === 'flv' || fileType === 'm4v' || fileType === 'wmv' || fileType === 'asf' || fileType === 'mkv' || fileType === 'mpeg'"
      :url="url" />
    <CompressViewer
      v-else-if="fileType === 'zip' || fileType === 'rar' || fileType === '7z' || fileType === 'tar' || fileType === 'gz' || fileType === 'bz2'"
      :url="url" />
